...
class RecommendedCard extends StatelessWidget {
  ...
  RecommendedCard(this.recommended, {Key? key}) : super(key: key);
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (contex) => Detail(recommended)));
      },
      child: Container(
                ...
                RichText(
                  text: TextSpan(children: [
                    TextSpan(
                        ...
                        style:
                            fw_500.copyWith(color: purpleColor, fontSize: 16)),
                    TextSpan(
                        text: ' / month',
